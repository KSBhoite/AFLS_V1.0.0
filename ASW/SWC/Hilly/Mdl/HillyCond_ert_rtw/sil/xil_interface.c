 ...
 *
 * SIL generated interface for code: "HillyCond"
 *
 */
   ...
   case XIL_OUTPUT_COMMAND:
    {
      ...
      if (!initComplete) {
        ...
        {
          void * dataAddress = (void *) &(HillyCond_U.S_SlfLuxInt);
        ...
        {
          void * dataAddress = (void *) &(HillyCond_U.S_LongiDistOppVeh);
          xil_fcnid0_task1_output_u[tableIdx].memUnitLength = 1 * sizeof(uint8_T);
          xil_fcnid0_task1_output_u[tableIdx++].address = (MemUnit_T *)
            dataAddress;
        }
        ...
        {
          void * dataAddress = (void *) &(HillyCond_U.S_LatDistPrlVeh);
          xil_fcnid0_task1_output_u[tableIdx].memUnitLength = 1 * sizeof(uint8_T);
          xil_fcnid0_task1_output_u[tableIdx++].address = (MemUnit_T *)
            dataAddress;
        }
        ...
        {
          void * dataAddress = (void *) &(HillyCond_U.S_SlfVehSpd);
          xil_fcnid0_task1_output_u[tableIdx].memUnitLength = 1 * sizeof(uint8_T);
          xil_fcnid0_task1_output_u[tableIdx++].address = (MemUnit_T *)
            dataAddress;
        }
        ...
        {
          void * dataAddress = (void *) &(HillyCond_U.S_SlfVehSteerAng);
