###########################################################################
## Makefile generated for component 'Hilly_Condition'. 
## 
## Makefile     : Hilly_Condition.mk
## Generated on : Fri Aug 23 22:13:41 2024
## Final product: ./Hilly_Condition.exe
...
PRODUCT_NAME              = Hilly_Condition
MAKEFILE                  = Hilly_Condition.mk
MATLAB_ROOT               = C:/PROGRA~1/POLYSP~1/R2021a
MATLAB_BIN                = C:/PROGRA~1/POLYSP~1/R2021a/bin
MATLAB_ARCH_BIN           = $(MATLAB_BIN)/win64
START_DIR                 = C:/Adaptive_Front_Light_System_V1.0.0/AFLS_V1.0.0/ASW/SWC/Hilly/Mdl
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = ISO_C
...
MODELREF_LINK_RSPFILE     = Hilly_Condition_ref.rsp
COMPILER_COMMAND_FILE     = Hilly_Condition_comp.rsp
CMD_FILE                  = Hilly_Condition.rsp
...
DEFINES_CUSTOM = 
DEFINES_OPTS = -DTID01EQ=0 -DXIL_SIGNAL_HANDLER=1 -DCODER_ASSUMPTIONS_ENABLED=1 -DRTIOSTREAM_RX_BUFFER_BYTE_SIZE=50000 -DRTIOSTREAM_TX_BUFFER_BYTE_SIZE=50000 -DCODE_INSTRUMENTATION_ENABLED=1 -DMEM_UNIT_BYTES=1 -DMemUnit_T=uint8_T
DEFINES_STANDARD = -DMODEL=Hilly_Condition -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
SRCS = $(MATLAB_ROOT)/toolbox/rtw/targets/pil/c/xil_interface_lib.c $(MATLAB_ROOT)/toolbox/rtw/targets/pil/c/xil_data_stream.c $(MATLAB_ROOT)/toolbox/rtw/targets/pil/c/xil_services.c $(START_DIR)/Hilly_Condition_ert_rtw/sil/xil_interface.c $(MATLAB_ROOT)/toolbox/rtw/targets/pil/c/xilcomms_rtiostream.c $(MATLAB_ROOT)/toolbox/rtw/targets/pil/c/xil_rtiostream.c $(MATLAB_ROOT)/toolbox/coder/rtiostream/src/utils/rtiostream_utils.c $(MATLAB_ROOT)/toolbox/rtw/targets/pil/c/coder_assumptions_app.c $(MATLAB_ROOT)/toolbox/rtw/targets/pil/c/coder_assumptions_data_stream.c $(MATLAB_ROOT)/toolbox/rtw/targets/pil/c/coder_assumptions_rtiostream.c $(MATLAB_ROOT)/toolbox/rtw/targets/pil/c/sil_main.c $(MATLAB_ROOT)/toolbox/rtw/targets/pil/c/target_io.c $(MATLAB_ROOT)/toolbox/coder/rtiostream/src/rtiostreamtcpip/rtiostream_tcpip.c $(START_DIR)/Hilly_Condition_ert_rtw/sil/xil_instrumentation.c $(MATLAB_ROOT)/toolbox/rtw/targets/pil/c/codeinstr_data_stream.c $(MATLAB_ROOT)/toolbox/rtw/targets/pil/c/codeinstr_rtiostream.c
...
MODELREF_LIBS = ../instrumented/Hilly_Condition.obj

LIBS = $(START_DIR)/Hilly_Condition_ert_rtw/coderassumptions/lib/Hilly_Condition_ca.lib
...
xil_interface.obj : $(START_DIR)/Hilly_Condition_ert_rtw/sil/xil_interface.c
	$(CC) $(CFLAGS) -o "$@" "$<"
...
xil_instrumentation.obj : $(START_DIR)/Hilly_Condition_ert_rtw/sil/xil_instrumentation.c
	$(CC) $(CFLAGS) -o "$@" "$<"
