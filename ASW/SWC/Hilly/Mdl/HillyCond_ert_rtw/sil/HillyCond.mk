###########################################################################
## Makefile generated for component 'HillyCond'. 
## 
## Makefile     : HillyCond.mk
## Generated on : Thu Aug 22 23:56:26 2024
## Final product: ./HillyCond.exe
...
MODELREF_LINK_RSPFILE     = HillyCond_ref.rsp
COMPILER_COMMAND_FILE     = HillyCond_comp.rsp
CMD_FILE                  = HillyCond.rsp
...
DEFINES_STANDARD = -DMODEL=HillyCond -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
SRCS = $(MATLAB_ROOT)/toolbox/rtw/targets/pil/c/xil_interface_lib.c $(MATLAB_ROOT)/toolbox/rtw/targets/pil/c/xil_data_stream.c $(MATLAB_ROOT)/toolbox/rtw/targets/pil/c/xil_services.c $(START_DIR)/HillyCond_ert_rtw/sil/xil_interface.c $(MATLAB_ROOT)/toolbox/rtw/targets/pil/c/xilcomms_rtiostream.c $(MATLAB_ROOT)/toolbox/rtw/targets/pil/c/xil_rtiostream.c $(MATLAB_ROOT)/toolbox/coder/rtiostream/src/utils/rtiostream_utils.c $(MATLAB_ROOT)/toolbox/rtw/targets/pil/c/coder_assumptions_app.c $(MATLAB_ROOT)/toolbox/rtw/targets/pil/c/coder_assumptions_data_stream.c $(MATLAB_ROOT)/toolbox/rtw/targets/pil/c/coder_assumptions_rtiostream.c $(MATLAB_ROOT)/toolbox/rtw/targets/pil/c/sil_main.c $(MATLAB_ROOT)/toolbox/rtw/targets/pil/c/target_io.c $(MATLAB_ROOT)/toolbox/coder/rtiostream/src/rtiostreamtcpip/rtiostream_tcpip.c
...
MODELREF_LIBS = ../HillyCond.obj

LIBS = $(START_DIR)/HillyCond_ert_rtw/coderassumptions/lib/HillyCond_ca.lib
...
xil_interface.obj : $(START_DIR)/HillyCond_ert_rtw/sil/xil_interface.c
	$(CC) $(CFLAGS) -o "$@" "$<"
